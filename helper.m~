...
for i = 2 : N      
    DYRK2(i) = DYRK2(i - 1) + delta_t * (-0.0003 * DYRK2(i - 1));
    p53helper(i) = p53helper(i - 1) + delta_t * (-DYRK2(i - 1) * p53helper(i - 1) / (0.1 + p53helper(i - 1)) + 0.5 - (0.1 + MDM2(i - 1)) * p53helper(i - 1) + kdpp53 * p53killer(i - 1) / (0.1 + p53killer(i - 1)));
    p53killer(i) = p53killer(i - 1) + delta_t * (DYRK2(i - 1) * p53helper(i - 1) / (0.1 + p53helper(i - 1)) - kdpp53 * p53killer(i - 1) / (0.1 + p53killer(i - 1)) - (0.1 + MDM2(i - 1) * p53killer(i - 1)));
    ...
    E2F1(i) = E2F1(i - 1) + delta_t * (-5 * RB(i - 1) * E2F1(i - 1) + kdsRE * RB_E2F1(i - 1));
...
ratio2 = abs(p53helper(N) / p53killer(N));
